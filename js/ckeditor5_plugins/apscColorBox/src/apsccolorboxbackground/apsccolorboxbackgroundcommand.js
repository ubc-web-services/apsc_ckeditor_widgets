/**
 * @file defines ApscColorBoxBackgroundCommand.
 */
 ...
 */
export default class ApscColorBoxBackgroundCommand extends Command {
  /**
   * Creates a new `ApscColorBoxBackgroundCommand` instance.
   *
  ...
  execute(options = {}) {
    ...
    const thisattribute = 'apscbackgroundclass';
